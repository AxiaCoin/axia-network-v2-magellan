...
WORKDIR /go/src/github.com/axiacoin/ortelius
...
COPY --from=builder /go/src/github.com/axiacoin/ortelius/docker/config.json /opt/config.json
COPY --from=builder /go/src/github.com/axiacoin/ortelius/services/db/migrations /opt/migrations
